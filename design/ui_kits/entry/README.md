...
Built from the specification (issue #1) and `src/http/app.ts`. The week grid is Orrey's own rendering
of its calendar, not a recreation of Google Calendar's interface.
